...
pygame.display.set_caption("Random acceleration car")
...
class Car():
    def __init__(self,screen):
        ...
        self.size = 20
        self.noise_value_x = 0.00001
        self.noise_value_y = 0.00001
    
    def update(self):
        
        self.noise_value_x+=random.choice([0.00001,-0.00001])
        self.noise_value_y+=random.choice([0.00001,-0.00001])
        self.acceleration = Vector(noise.pnoise1(self.noise_value_x),noise.pnoise1(self.noise_value_y))
...
while running:
    ...
    # if keys[pygame.K_UP]:
    #     car.acceleration.add(Vector(0.001,0))
